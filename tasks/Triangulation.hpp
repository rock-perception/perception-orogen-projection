...
#ifndef PROJECTION_TRIANGULATION_TASK_HPP
...
namespace projection {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','projection::Triangulation')
     end
     \endverbatim
    ...
    public:
         ...
         */
        Triangulation(std::string const& name = "projection::Triangulation");
         ...
         * 
         */
        Triangulation(std::string const& name, RTT::ExecutionEngine* engine);

        /** Default deconstructor of Triangulation
         */
	~Triangulation();
